    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/learn" className="text-gray-700 hover:text-blue-600 transition-colors">Learn Hub</Link>
              <Link href="/manifesto" className="text-gray-700 hover:text-blue-600 transition-colors">Manifesto</Link>
              <Link href="/manual" className="text-gray-700 hover:text-blue-600 transition-colors font-semibold">Manual</Link>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-8 border border-blue-100 max-w-4xl mx-auto">
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-semibold text-gray-900 mb-3">Lightning-Fast Development</h3>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100 max-w-5xl mx-auto">
              <div className="flex items-center space-x-4 mb-4">
                <Target className="w-8 h-8 text-blue-600" />
                <h3 className="text-2xl font-semibold text-gray-900">Custom Software Development</h3>
              </div>
              <p className="text-gray-600 mb-4 leading-relaxed">
                Tailored applications built from the ground up to meet your specific business requirements and workflows.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm">Web Applications</span>
                <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm">Mobile Apps</span>
                <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm">Desktop Software</span>
                <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm">API Development</span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100 max-w-5xl mx-auto">
              <div className="flex items-center space-x-4 mb-4">
                ...
                <h3 className="text-2xl font-semibold text-gray-900">Cloud Solutions & DevOps</h3>
              </div>
              <p className="text-gray-600 mb-4 leading-relaxed">
                Scalable cloud infrastructure and automated deployment pipelines for reliable, high-performance applications.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm">AWS/Azure</span>
                <span className="px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm">CI/CD Pipelines</span>
                <span className="px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm">Containerization</span>
                <span className="px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm">Monitoring</span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100 max-w-5xl mx-auto">
              <div className="flex items-center space-x-4 mb-4">
                ...
                <h3 className="text-2xl font-semibold text-gray-900">Digital Transformation</h3>
              </div>
              <p className="text-gray-600 mb-4 leading-relaxed">
                Strategic technology consulting to modernize your business processes and drive digital innovation.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-sm">Process Automation</span>
                <span className="px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-sm">Data Analytics</span>
                <span className="px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-sm">AI Integration</span>
                <span className="px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-sm">Legacy Modernization</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 md:p-12 text-white max-w-5xl mx-auto">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-6 text-sm text-gray-400">
              <span>© 2024 Radiant Systems. All rights reserved.</span>
